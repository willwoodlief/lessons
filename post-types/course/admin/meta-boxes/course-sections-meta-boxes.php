...
*/
class ElatedfLMSCourseSectionsMetaBox implements ieSmartsElatedInterfaceRender {
    private $name;
    private $label;
    private $description;
    ...
    public function render($factory) {
        ...
        foreach ($lessons as $lesson) {
            $eltd_lessons[$lesson->ID] = $lesson->post_title;
        }
        ...
        foreach ($quizzes as $quiz) {
            $eltd_quizzes[$quiz->ID] = $quiz->post_title;
        }
                    ...
                    <div class="eltdf-repeater-field-item">
                        <div class="eltdf-page-form-section eltdf-repeater-field eltdf-no-description">
                            <div class="eltdf-section-content">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4><?php esc_html_e('Section Name', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <input type="text" class="form-control eltdf-input eltdf-form-element" placeholder="" value="<?php echo esc_attr($value['section_name']); ?>" name="eltdf_course_curriculum[<?php echo esc_attr($i); ?>][section_name]">
                                            </div>
                                            <h4><?php esc_html_e('Section Title', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <input type="text" class="form-control eltdf-input eltdf-form-element" placeholder="" value="<?php echo esc_attr($value['section_title']); ?>" name="eltdf_course_curriculum[<?php echo esc_attr($i); ?>][section_title]">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <h4><?php esc_html_e('Section Description', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <textarea type="text" rows="6" class="form-control eltdf-input eltdf-form-element" placeholder="" name="eltdf_course_curriculum[<?php echo esc_attr($i); ?>][section_description]"><?php echo esc_attr($value['section_description']); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <?php foreach($value['section_elements'] as $element) : ?>
                                    ...
                                    <div class="eltdf-course-element eltdf-repeater-fields-row eltdf-sort-child second-level" data-index="<?php echo esc_attr($j); ?>">
                                        <div class="eltdf-repeater-fields-row-inner">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="eltdf-inner-field-holder">
                                                                        ...
                                                                        <select class="eltdf-select2 form-control eltdf-form-element" name="eltdf_course_curriculum[<?php echo esc_attr($i); ?>][section_elements][<?php echo esc_attr($j); ?>][value]">
                                                                            <?php foreach($eltd_lessons as $key=>$value) { if ($key == "-1") $key = ""; ?>
                                            ...
                                            <div class="eltdf-repeater-remove">
                                                <a href="#" class="eltdf-course-lesson-remove-item" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Section', 'eltdf-lms'); ?>"><i class="fa fa-times"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="eltdf-course-element eltdf-repeater-fields-row eltdf-sort-child second-level" data-index="<?php echo esc_attr($j); ?>">
                                        <div class="eltdf-repeater-fields-row-inner">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12">
                                                                    <div class="eltdf-inner-field-holder">
                                                                        ...
                                                                        <select class="eltdf-select2 form-control eltdf-form-element" name="eltdf_course_curriculum[<?php echo esc_attr($i); ?>][section_elements][<?php echo esc_attr($j); ?>][value]">
                                                                            <?php foreach($eltd_quizzes as $key=>$value) { if ($key == "-1") $key = ""; ?>
                                                                                <option <?php if ($element['value'] == $key) { echo "selected='selected'"; } ?>  value="<?php echo esc_attr($key); ?>"><?php echo esc_html($value); ?></option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                            ...
                                            <div class="eltdf-repeater-remove">
                                                <a href="#" class="eltdf-course-quiz-remove-item" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Section', 'eltdf-lms'); ?>"><i class="fa fa-times"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                        ...
                        <div class="eltdf-course-section-controls">
                            <div class="eltdf-repeater-add">
                                <a id="eltdf-course-lesson-add" href="#" class="btn btn-primary"><?php esc_html_e('Add New Lesson', 'eltdf-lms'); ?></a>
                                <a id="eltdf-course-quiz-add" href="#" class="btn btn-primary"><?php esc_html_e('Add New Quiz', 'eltdf-lms'); ?></a>
                            </div>
                        </div>
                    </div>
                    <div class="eltdf-repeater-remove">
                        <a href="#" class="eltdf-course-section-remove-item" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Section', 'eltdf-lms'); ?>"><i class="fa fa-times"></i></a>
                    </div>
                </div>
            </div>
            <?php
        ...
        <div class="eltdf-course-section-controls">
            <div class="eltdf-repeater-add">
                <a id="eltdf-course-section-add" href="#" class="btn btn-primary"><?php esc_html_e('Add New Section', 'eltdf-lms'); ?></a>
            </div>
        </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <h4><?php esc_html_e('Section Name', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <input type="text" class="form-control eltdf-input eltdf-form-element" placeholder="" name="eltdf_course_curriculum[{{{ data.rowIndex }}}][section_name]">
                                            </div>
                                            <h4><?php esc_html_e('Section Title', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <input type="text" class="form-control eltdf-input eltdf-form-element" placeholder="" name="eltdf_course_curriculum[{{{ data.rowIndex }}}][section_title]">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <h4><?php esc_html_e('Section Description', 'eltdf-lms'); ?></h4>
                                            <div class="form-group">
                                                <textarea type="text" rows="6" class="form-control eltdf-input eltdf-form-element" placeholder="" name="eltdf_course_curriculum[{{{ data.rowIndex }}}][section_description]"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/html" id="tmpl-eltdf-section-lesson-template">
            <div class="eltdf-course-element eltdf-repeater-fields-row eltdf-sort-child second-level" data-index="{{{ data.lessonIndex }}}">
                <div class="eltdf-repeater-fields-row-inner">
                    ...
                    <div class="eltdf-repeater-remove">
                        <a href="#" class="eltdf-course-lesson-remove-item" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Lesson', 'eltdf-lms'); ?>"><i class="fa fa-times"></i></a>
                    </div>
                </div>
            </div>
        </script>
        ...
        <script type="text/html" id="tmpl-eltdf-section-quiz-template">
            <div class="eltdf-course-element eltdf-repeater-fields-row eltdf-sort-child second-level" data-index="{{{ data.quizIndex }}}">
                <div class="eltdf-repeater-fields-row-inner">
                    ...
                    <div class="eltdf-repeater-remove">
                        <a href="#" class="eltdf-course-lesson-remove-item" data-toggle="tooltip" data-placement="left" title="<?php esc_html_e('Remove Quiz', 'eltdf-lms'); ?>"><i class="fa fa-times"></i></a>
                    </div>
                </div>
            </div>
        </script>

...
(function($) {
    ...
    function eltdfQuestionAnswerChange() {
        ...
        radios.change(function() {
            checkForm.find('input[name=eltdf_lms_question_answer]').val(this.value);
            nextForm.find('input[name=eltdf_lms_question_answer]').val(this.value);
            prevForm.find('input[name=eltdf_lms_question_answer]').val(this.value);
            finishForm.find('input[name=eltdf_lms_question_answer]').val(this.value);
        });
        ...
        checkboxes.on('change', function() {
            ...
            checkForm.find('input[name=eltdf_lms_question_answer]').val(values);
            nextForm.find('input[name=eltdf_lms_question_answer]').val(values);
            prevForm.find('input[name=eltdf_lms_question_answer]').val(values);
            finishForm.find('input[name=eltdf_lms_question_answer]').val(values);
        }).change();

        textbox.on("change paste keyup", function() {
            checkForm.find('input[name=eltdf_lms_question_answer]').val($(this).val());
            nextForm.find('input[name=eltdf_lms_question_answer]').val($(this).val());
            prevForm.find('input[name=eltdf_lms_question_answer]').val($(this).val());
            finishForm.find('input[name=eltdf_lms_question_answer]').val($(this).val());
        });
    }
    ...
    function eltdfUpdateQuestionId(questionId) {
        var finishForm = $('.eltdf-lms-finish-quiz-form');
        finishForm.find('input[name=eltdf_lms_question_id]').val(questionId);
    }
    ...
    function eltdfQuestionHint() {
        ...
        $('.eltdf-lms-question-actions-hint-form').on('submit',function(e) {
            ...
            var form = $(this);
            var formData = form.serialize();
            var timeRemaining = $('input[name=eltdf_lms_time_remaining]');
            formData += '&eltdf_lms_time_remaining=' + timeRemaining.val();
            var ajaxData = {
    ...
    function eltdfQuestionCheck() {
        ...
        $('.eltdf-lms-question-actions-check-form').on('submit',function(e) {
            ...
            formData += '&eltdf_lms_time_remaining=' + timeRemaining.val();
            var ajaxData = {
                action: 'eltdf_lms_check_question_answer',
                post: formData
            };
            form.find('input').prop("disabled", true);
            $.ajax({
    ...
    function eltdfQuestionChange() {
        ...
        $('.eltdf-lms-question-prev-form, .eltdf-lms-question-next-form').on('submit',function(e) {
            ...
            var formData = form.serialize();
            var timeRemaining = $('input[name=eltdf_lms_time_remaining]');
            var retakeId = $('input[name=eltdf_lms_retake_id]');
            formData += '&eltdf_lms_time_remaining=' + timeRemaining.val();
            formData += '&eltdf_lms_retake_id=' + retakeId.val();
            var ajaxData = {
                action: 'eltdf_lms_change_question',
                post: formData
            };
    ...
    function eltdfQuestionSave() {
        $(window).unload(function() {
            ...
            var ajaxData = {
                action: 'eltdf_lms_save_question',
                post: formData
            };
...
(function($) {
    ...
    function eltdfLoadQuizQuestion(questionId ,quizId, courseId, retake, container){
        ...
        var ajaxData = {
            action: 'eltdf_lms_load_first_question',
